...
import { View, Text, StyleSheet, Keyboard, TouchableWithoutFeedback 
} from 'react-native';
...
export default function IMCTab() {
  ...
  const calcular = () => {
    // Esconde el teclado automáticamente al darle al botón calcular
    Keyboard.dismiss(); 
  ...
  return (
    // ¡ESTO ES LO QUE QUITA EL TECLADO AL TOCAR LA PANTALLA!
